        ...
        <>
            ...
            <div className="flex justify-center">
                <div className="lg:w-[1086px] flex flex-col w-[80%] leading-relaxed">
                    ...
                    <p>
                    El plan de carrera es una herramienta estratégica crucial dentro de las organizaciones, que busca promover el desarrollo y crecimiento profesional de los empleados mientras se alinean con los objetivos organizacionales. Según <Link className='text-blue-500 underline' href="https://elibro.net/es/ereader/uniminuto/66700?page=206" target='_blank' rel="noopener noreferrer">Alles (2009)</Link>, estos planes no solo ayudan a los empleados a visualizar su futuro dentro de la empresa, sino que también contribuyen a la sostenibilidad y continuidad de la organización. Un plan de carrera estructurado es esencial para identificar, formar y retener a los futuros líderes de una organización. Ya que, asegura una transición efectiva en puestos clave y maximizando el potencial del talento humano. 
                    </p>
                    <br />
                    <p className="flex justify-center w-full my-10">
                    <iframe width="560" height="315" src="https://www.youtube.com/embed/JkD9oyd5GF0?si=18_TtL41ZCQnKGB_" title="YouTube video player"></iframe>
                    </p>
                    <br />
                    <p>
...
<br />
                    ...
                    <h1 className='text-xl font-bold mb-2 mt-2'>
                    Pasos para Crear un Plan de Desarrollo Profesional
                    </h1>
...
<ul className='list-decimal lg:ps-10 flex flex-col gap-y-4 '>
    ...
    <li><b>Crear un plan de acción:</b> Definir las actividades necesarias para alcanzar los objetivos establecidos.</li>
...
<ul className="flex flex-col gap-y-4 list-decimal lg:ps-10">
    ...
    <li><b>Desarrollo de futuros líderes:</b> Un plan de carrera facilita la identificación de talentos internos que pueden ocupar posiciones de liderazgo en el futuro (Alles, 2009).</li>
    <li><b>Alineación de objetivos:</b> Ayuda a asegurar que los objetivos personales de los empleados estén alineados con los objetivos estratégicos de la organización.</li>
</ul>
...
<p>Gabriel, N. (2025).
    ...
    <br />
    <p className="my-2">Asana (2025, febrero 12). Desarrollo profesional: cómo hacer un plan de carrera en 6 pasos. Asana. <Link href="https://asana.com/es/resources/professional-development-plan" target='_blank' className='text-blue-500 underline'>https://asana.com/es/resources/professional-development-plan</Link></p>
    <br />
    <p className="my-2">
    Motley, R. J., & McMullin, A. (2020). Developing your professional career plan. Family Practice Management. <Link className="text-blue-500 underline" href={"https://www.aafp.org/pubs/fpm/issues/2020/0700/p21.html"} target='_blank'>
